using System;
using Transer.Tecnologia.Automatizacion.caWsTysBavariaLogicaNegocio;

namespace Transer.Tecnologia.Automatizacion.caWsBavaria
{
    class WsBavaria
    {
        static void Main(string[] args)
        {
            ...
            ILogicaNegocio ln = new LogicaNegocio(usuario, password, usuEmail, passEmail, ambiente);
            string estado = string.Empty;
            ln.Inicio(DateTime.Now);
        }
